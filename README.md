...
[![Watch Walkthrough](https://img.shields.io/badge/▶_Watch_Video_Walkthrough-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtu.be/27dancSDNOo)
...
- Reduced dataset from 1,067,371 → 805,549 rows through systematic filtering
...
Built a 3-page executive dashboard telling the story from overview → deep-dive → retention analysis.
...
![Executive Overview](Power_BI/1.Executive%20Overview.png)

### Page 2 — Customer Segmentation Deep Dive
*Who are our best customers? Who's at risk? Where's the value concentrated?*

![Customer Segmentation](Power_BI/2.Customer%20Segmentation.png)

### Page 3 — Cohort Retention Analysis
*Why are customers leaving, and when?*

![Cohort Retention](Power_BI/3.Cohort%20Retention%20Analysis.png)
...
│   ├── 2.Customer Segmentation.png
│   └── 3.Cohort Retention Analysis.png
│
...
[![Watch the Walkthrough](https://img.shields.io/badge/▶_Watch_on_YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtu.be/27dancSDNOo)
